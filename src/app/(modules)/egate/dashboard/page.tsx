  ...
  return (
    <div className="flex flex-col gap-8">
       <Breadcrumb>
        <BreadcrumbList>
          <BreadcrumbItem>
            <BreadcrumbLink href="/egate/dashboard">Dashboard</BreadcrumbLink>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
      <DashboardHeader 
      ...
      />
        <div className="flex flex-col gap-8">
            ...
            <div className="grid gap-4 md:grid-cols-3 lg:grid-cols-6">
                ...
                <StatCard title={t('activeAlerts')} value="2" icon={ShieldAlert} color="text-yellow-500" />
                <StatCard title={t('avgProcessingTime')} value={data?.main?.avgProcessingTime?.egate || '...'} icon={Clock} color="text-orange-500" />
            </div>
            )}
