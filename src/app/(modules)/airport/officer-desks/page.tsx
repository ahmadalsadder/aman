...
export default function AirportOfficerDesksPage() {
    ...
    const canView = useMemo(() => hasPermission(['airport:desks:view']), [hasPermission]);
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            ...
            const [desksResult, portsResult, terminalsResult] = await Promise.all([
                api.get<OfficerDesk[]>(`/data/desks?moduleType=airport`),
