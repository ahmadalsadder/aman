...
export default function AddSeaportOfficerDeskPage() {
    ...
    const canCreate = hasPermission(['seaport:desks:create']);
    ...
    const handleSave = async (formData: OfficerDeskFormValues) => {
        ...
        if (result.isSuccess) {
            ...
            router.push('/seaport/officer-desks');
        } else {
            toast({
    ...
    return (
        <div className="space-y-6">
            <Breadcrumb>
                <BreadcrumbList>
                    <BreadcrumbItem>
                        <BreadcrumbLink href="/seaport/dashboard" icon={LayoutDashboard}>{tNav('dashboard')}</BreadcrumbLink>
                    </BreadcrumbItem>
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                        <BreadcrumbLink href="/seaport/officer-desks" icon={Monitor}>{tNav('officerDesks')}</BreadcrumbLink>
                    </BreadcrumbItem>
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
