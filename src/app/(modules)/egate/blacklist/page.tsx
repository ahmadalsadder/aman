...
export default function EgateBlacklistPage() {
    const [blacklist, setBlacklist] = useState<BlacklistEntry[]>([]);
    const [loading, setLoading] = useState(true);
    const { toast } = useToast();
    const { hasPermission } = useAuth();
    
    const canView = useMemo(() => hasPermission(['egate:blacklist:view' as Permission]), [hasPermission]);
    ...
    return <BlacklistPage module="egate" blacklist={blacklist} loading={loading} onDeleteEntry={handleDeleteEntry} />;
}
