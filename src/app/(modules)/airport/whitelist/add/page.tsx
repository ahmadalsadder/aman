...
import type { Passenger, WhitelistEntry } from '@/types/live-processing';
import { PlusCircle, ShieldAlert, AlertTriangle, Search, Loader2, ListChecks, LayoutDashboard } from 'lucide-react';
...
export default function AddAirportWhitelistPage() {
    ...
    const canCreate = hasPermission([`${module}:whitelist:create`]);
    ...
    return (
        <div className="space-y-6">
            ...
            <WhitelistForm onSave={handleSave} isLoading={isLoading} passenger={searchedPassenger} />
        </div>
    );
}
